...
function CartPriceTable() {
  ...
  <div className="display-right">Rs. {getMRP()}</div>
      </div>
      <div className="price-row">
        <div
          className={broadLeftMargin ? "display-left-large" : "display-left"}
  ...
  <div className="display-right">Rs. {getDiscount()}</div>
      </div>
      {coupon.discount && (
        <div className="price-row">
          <div
          ...
          <div className="display-right">Rs. {coupon.discount}</div>
        </div>
      )}
      <div className="price-row">
        <div
        ...
        <div className="display-right">
          <span className="strikethrough">Rs. 99</span>
  ...
  <div className="display-right">Rs. {getTotalPrice()}</div>
      </div>
    </div>
  );
}
